...
jQuery( function( $ ) {
	...
	var wc_checkout_form = {
		...
		init_payment_methods: function() {
			$( '.woocommerce-checkout' ).find( '.payment_method_wc_telr_apple_pay' ).hide();																	   
			...
			if ( $form.triggerHandler( 'checkout_place_order' ) !== false && $form.triggerHandler( 'checkout_place_order_' + wc_checkout_form.get_payment_method() ) !== false ) {
				...
				$.ajax({
					...
					success:	function( result ) {
						try {
							if( 'success' === result.result && result.iframe_url != undefined){
								$(".payment_box.payment_method_wctelr").html('<iframe style="width: 100%;height: 500px;border: 0;" id= "telr" src= "' + result.iframe_url + '"  sandbox="allow-forms allow-modals allow-popups-to-escape-sandbox allow-popups allow-scripts allow-top-navigation allow-same-origin"></iframe>');
